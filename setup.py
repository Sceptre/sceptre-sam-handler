...
# the template_handler call in sceptre e.g. !command_name.
TEMPLATE_HANDLER_COMMAND_NAME = 'custom_template_handler'
# do not change. Rename template_handler/template_handler.py to template_handler/{TEMPLATE_HANDLER_COMMAND_NAME}.py
TEMPLATE_HANDLER_MODULE_NAME = 'template_handler.{}'.format(TEMPLATE_HANDLER_COMMAND_NAME)
...
setup(
    ...
    entry_points={
        'sceptre.template_handlers': [
            "{}={}:{}".format(TEMPLATE_HANDLER_COMMAND_NAME,
                              TEMPLATE_HANDLER_MODULE_NAME, TEMPLATE_HANDLER_CLASS)
        ]
    },
